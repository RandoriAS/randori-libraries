package ember {
	...
	[JavaScript(export="false",name="ember.NativeArray")]
	[JavaScriptConstructor(factoryMethod="ember.NativeArray.create(...args)")]
	public class NativeArray {
		...
		/**
		 * <p>Activates the mixin on the Array.prototype if not already applied. Calling
		 * this method more than once is safe.</p>
		 */
		...
		/**
		 * Creates a new <code>NativeArray</code> instance.
		 */
		public function NativeArray(arguments:Object) {
		}
		 ...
		 * </p>
		 */
		public static function create(arguments:Object):NativeArray {
			return null;
		}

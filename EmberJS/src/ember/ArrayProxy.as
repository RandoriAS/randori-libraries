package ember {
	...
	[JavaScript(export="false",name="ember.ArrayProxy")]
	[JavaScriptConstructor(factoryMethod="ember.ArrayProxy.create(...args)")]
	public class ArrayProxy {
		...
		/**
		 * Creates a new <code>ArrayProxy</code> instance.
		 */
		public function ArrayProxy(arguments:Object) {
		}
		 ...
		 * </p>
		 */
		public static function create(arguments:Object):ArrayProxy {
			return null;
		}

package ember {
	...
	[JavaScript(export="false",name="ember.Select")]
	[JavaScriptConstructor(factoryMethod="ember.Select.create(...args)")]
	public class Select {
		/**
		 ...
		 * <p>
		 *   If
		 *   <code>optionLabelPath</code>
		 *   and
		 *   <code>optionValuePath</code>
		 ...
		 *               }
		 *     ]),
		 *               <span class="key">optionLabelPath</span>
		 *               :
		 *               <span class="string">
		 *                 <span class="delimiter">'</span>
		 *                 <span class="content">content.firstName</span>
		 *                 <span class="delimiter">'</span>
		 *               </span>
		 *               ,
		 *               <span class="key">optionValuePath</span>
		 *               :
		 *               <span class="string">
		 *                 <span class="delimiter">'</span>
		 *                 <span class="content">content.id</span>
		 *                 <span class="delimiter">'</span>
		 *               </span>
		 *               });
		 *             </pre>
		 ...
		 *   defaultTemplate: precompileTemplate('{{#if view.prompt}}</p>
		 * {{view.prompt}}{{/if}}{{#each view.content}}{{view view.optionView contentBinding="this"}}{{/each}}'),
		...
		/**
		 * <p>
		 *   The path of the option values. See
		 *   <code>content</code>
		 *   .
		 * </p>
		 */
		...
		/**
		 * <p>The view class for option.</p>
		 */
		public var optionView:View;

		/**
		 * <p>If given, a top-most dummy option will be rendered to serve as a user
		 * prompt.</p>
		 */
		...
		/**
		 * Creates a new <code>Select</code> instance.
		 */
		public function Select(arguments:Object) {
		}
		 ...
		 * </p>
		 */
		public static function create(arguments:Object):Select {
			return null;
		}
...
[JavaScriptMethod(name="on")]
		 ...
		 *   . Most users will want to override the
		 *   <code>template</code>
		 *   or
		 *   <code>templateName</code>
		 ...
		 *   By default,
		 *   <code>Ember.View</code>
		 *   will look for a function in the
		 *   <code>template</code>
		 *   property and invoke it with the value of
		 *   <code>context</code>
		 *   . The value of
		 *   <code>context</code>
		 ...
		 * </p>
		 */
		public function render(buffer:RenderBuffer):void {
		}

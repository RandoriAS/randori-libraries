package ember {
	...
	[JavaScript(export="false",name="ember.HashLocation")]
	[JavaScriptConstructor(factoryMethod="ember.HashLocation.create(...args)")]
	public class HashLocation {
		...
		/**
		 * Creates a new <code>HashLocation</code> instance.
		 */
		public function HashLocation(arguments:Object) {
		}
		 ...
		 * </p>
		 */
		public static function create(arguments:Object):HashLocation {
			return null;
		}

package ember {
	...
	[JavaScript(export="false",name="ember.Array")]
	[JavaScriptConstructor(factoryMethod="ember.Array.create(...args)")]
	public class EmberArray {
		/**
		...
		/**
		 * Creates a new <code>EmberArray</code> instance.
		 */
		public function EmberArray(arguments:Object) {
		}
		 ...
		 * </p>
		 */
		public static function create(arguments:Object):EmberArray {
			return null;
		}

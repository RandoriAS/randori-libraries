package ember {
	...
	[JavaScript(export="false",name="ember.MutableEnumerable")]
	[JavaScriptConstructor(factoryMethod="ember.MutableEnumerable.create(...args)")]
	public class MutableEnumerable {
		/**
		...
		/**
		 * Creates a new <code>MutableEnumerable</code> instance.
		 */
		public function MutableEnumerable(arguments:Object) {
		}
		 ...
		 * </p>
		 */
		public static function create(arguments:Object):MutableEnumerable {
			return null;
		}

package ember {
	...
	[JavaScript(export="false",name="ember.DefaultResolver")]
	[JavaScriptConstructor(factoryMethod="ember.DefaultResolver.create(...args)")]
	public class DefaultResolver {
		...
		/**
		 * Creates a new <code>DefaultResolver</code> instance.
		 */
		public function DefaultResolver(arguments:Object) {
		}
		 ...
		 * </p>
		 */
		public static function create(arguments:Object):DefaultResolver {
			return null;
		}
...
[JavaScriptMethod(name="get")]
		 ...
		 * It parses the provided
		 *   <code>fullName</code>
		 *   and then looks up and
		 * returns the appropriate template or class.
		 * </p>
		 */
		public function resolve(fullName:String):Object {
			return null;
		}
		 ...
		 */
		public function resolveOther():void {
		}
		 ...
		 */
		public function resolveTemplate():void {
		}

		public function resolveView():void {
		}
...
[JavaScriptMethod(name="set")]
		...
		/**
		 * <p>
		 *   Given a parseName object (output from
		 *   <code>parseName</code>
		 *   ), apply
		 * the conventions expected by
		 *   <code>Ember.Router</code>
		 * </p>
		 */
		public function useRouterNaming():void {
		}

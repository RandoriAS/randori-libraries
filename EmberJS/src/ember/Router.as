package ember {
	...
	[JavaScript(export="false",name="ember.Router")]
	[JavaScriptConstructor(factoryMethod="ember.Router.create(...args)")]
	public class Router {
		/**
		...
		/**
		 * Creates a new <code>Router</code> instance.
		 */
		public function Router(arguments:Object) {
		}
		 ...
		 * </p>
		 */
		public static function create(arguments:Object):Router {
			return null;
		}

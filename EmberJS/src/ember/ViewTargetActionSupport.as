package ember {
	...
	[JavaScript(export="false",name="ember.ViewTargetActionSupport")]
	[JavaScriptConstructor(factoryMethod="ember.ViewTargetActionSupport.create(...args)")]
	public class ViewTargetActionSupport {
		public var actionContext:Object;
		...
		/**
		 * Creates a new <code>ViewTargetActionSupport</code> instance.
		 */
		public function ViewTargetActionSupport(arguments:Object) {
		}
		 ...
		 * </p>
		 */
		public static function create(arguments:Object):ViewTargetActionSupport {
			return null;
		}

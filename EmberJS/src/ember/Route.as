package ember {
	...
	[JavaScript(export="false",name="ember.Route")]
	[JavaScriptConstructor(factoryMethod="ember.Route.create(...args)")]
	public class Route {
		/**
		...
		/**
		 * <p>The collection of functions keyed by name available on this route as
		 * action targets.</p>
		 * <p>
		 ...
		 * </p>
		 * <p>
		 *   Events can also be invoked from other parts of your application via
		 *   <code>Route#send</code>
		 *   .
		 * </p>
		 * <p>The context of event will be the this route.</p>
		 */
		...
		/**
		 * <p>This hook is executed when the router enters the route for the first time.
		 * It is not executed when the model for the route changes.</p>
		 */
		...
		/**
		 * <p>Returns the controller for a particular route.</p>
		 ...
		 *               <span class="function">setupController</span>
		 *               :
		 *               <span class="keyword">function</span>
		 *               (controller, post) {
		 *               <span class="local-variable">this</span>
		 *               ._super(controller, post);
		 *               <span class="local-variable">this</span>
		 *               .controllerFor(
		 *               <span class="string">
		 *                 <span class="delimiter">'</span>
		 ...
		 *               <span class="string">
		 *                 <span class="delimiter">'</span>
		 *                 <span class="content">currentPost</span>
		 *                 <span class="delimiter">'</span>
		 *               </span>
		 *               , post);
		 *   }
		 ...
		 * </div>
		 * <p>
		 *   By default, the controller for
		 *   <code>post</code>
		 *   is the shared instance of
		 *   <code>App.PostController</code>
		 *   .
		 * </p>
		 */
		public function controllerFor(name:String, model:Object):Object {
			return null;
		}

		/**
		 * Creates a new <code>Route</code> instance.
		 */
		public function Route(arguments:Object) {
		}
		 ...
		 * </p>
		 */
		public static function create(arguments:Object):Route {
			return null;
		}
...
[JavaScriptMethod(name="get")]
		 ...
		 *               <span class="string">
		 *                 <span class="delimiter">'</span>
		 *                 <span class="content">/posts/:post_id</span>
		 *                 <span class="delimiter">'</span>
		 *               </span>
		 *               });
		 * });
		 ...
		 *   <code>post</code>
		 *   route is
		 *   <code>App.Post.find(params.post_id)</code>
		 *   .
		 * </p>
		 * <p>
		 *   By default, if your route has a dynamic segment ending in
		 *   <code>_id</code>
		 *   :
		 * </p>
		 * <ul>
		 ...
		 * through a transition (e.g. when using the
		 *   <code>linkTo</code>
		 *   Handlebars
		 ...
		 * </p>
		 */
		public function model(params:Object):void {
		}

		/**
		 * <p>Returns the current model for a given route.</p>
		 * <p>
		 ...
		 * </p>
		 */
		public function modelFor(name:String):Object {
			return null;
		}
		 ...
		 * <p>
		 *   If you call
		 *   <code>this.transitionTo</code>
		 *   from inside of this hook, this route
		 * will not be entered in favor of the other hook.
		 * </p>
		 */
		public function redirect(model:Object):void {
		}
		...
		/**
		 * <p>Renders a template into an outlet.</p>
		 * <p>This method has a number of defaults, based on the name of the
		 * route specified in the router.</p>
		 * <p>For example:</p>
		 * <div class="highlight js ">
		 *   <div class="ribbon"/>
		 *   <div class="scroller">
		 ...
		 *   The name of the
		 *   <code>PostRoute</code>
		 *   , as defined by the router, is
		 *   <code>post</code>
		 *   .
		 * </p>
		 * <p>By default, render will:</p>
		 * <ul>
		 *   <li>
		 *     render the
		 *     <code>post</code>
		 ...
		 *   </li>
		 * </ul>
		 * <p>You can override this behavior:</p>
		 * <div class="highlight js ">
		 *   <div class="ribbon"/>
		 *   <div class="scroller">
		 *     <table class="CodeRay">
		 ...
		 *               <span class="string">
		 *                 <span class="delimiter">'</span>
		 *                 <span class="content">myPost</span>
		 *                 <span class="delimiter">'</span>
		 *               </span>
		 *               , {
		 *               <span class="comment">// the template to render</span>
		 *               <span class="key">into</span>
		 *               :
		 *               <span class="string">
		 *                 <span class="delimiter">'</span>
		 *                 <span class="content">index</span>
		 ...
		 *               </span>
		 *               ,
		 *               <span class="comment">// the template to render into</span>
		 ...
		 *               </span>
		 *               ,
		 *               <span class="comment">// the name of the outlet in that template</span>
		 ...
		 *                 <span class="delimiter">'</span>
		 *               </span>
		 *               <span class="comment">// the controller to use for the template</span>
		 *               });
		 *   }
		 * });
		 *             </pre>
		 ...
		 * </div>
		 * <p>
		 *   Remember that the controller's
		 *   <code>content</code>
		 *   will be the route's model. In
		 * this case, the default model will be
		 *   <code>App.Post.find(params.post_id)</code>
		 *   .
		 * </p>
		 */
		public function render(name:String, options:Object):void {
		}
		 ...
		 */
		public function renderTemplate(controller:Object, model:Object):void {
		}
		 ...
		 * possible. Identical to
		 *   <code>transitionTo</code>
		 *   in all other respects.
		 * </p>
		 */
		public function replaceWith(name:String, models:Object):void {
		}
		 ...
		 *   The default
		 *   <code>serialize</code>
		 *   method inserts the model's
		 *   <code>id</code>
		 *   into the
		 * route's dynamic segment (in this case,
		 *   <code>:post_id</code>
		 *   ).
		 * </p>
		 * <p>
		 ...
		 * </p>
		 */
		public function serialize(model:Object, params:Array):Object {
			return null;
		}
...
[JavaScriptMethod(name="set")]
		 ...
		 *   .
		 * </p>
		 * <p>If no explicit controller is defined, the route will automatically create
		 * an appropriate controller for the model:</p>
		 * <ul>
		 *   <li>
		 *     if the model is an
		 *     <code>Ember.Array</code>
		 *     (including record arrays from Ember
		 * Data), the controller is an
		 *     <code>Ember.ArrayController</code>
		 *     .
		 *   </li>
		 *   <li>
		 *     otherwise, the controller is an
		 *     <code>Ember.ObjectController</code>
		 *     .
		 *   </li>
		 * </ul>
		 * <p>This means that your template will get a proxy for the model as its
		 ...
		 * </p>
		 */
		public function transitionTo(name:String, models:Object):void {
		}

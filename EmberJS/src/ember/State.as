package ember {
	...
	[JavaScript(export="false",name="ember.State")]
	[JavaScriptConstructor(factoryMethod="ember.State.create(...args)")]
	public class State {
		/**
		 ...
		 */
		public function State(arguments:Object) {
		}
		 ...
		 * </p>
		 */
		public static function create(arguments:Object):State {
			return null;
		}

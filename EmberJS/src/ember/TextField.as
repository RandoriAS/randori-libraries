package ember {
	...
	[JavaScript(export="false",name="ember.TextField")]
	[JavaScriptConstructor(factoryMethod="ember.TextField.create(...args)")]
	public class TextField {
		 ...
		 * the text field has an
		 *   <code>action</code>
		 *   set, the action will be sent to the view's
		 * controller and the key event will stop propagating.
		 * </p>
		 * <p>
		 *   If you would like parent views to receive the
		 *   <code>keyUp</code>
		 *   event even after an
		 * action has been dispatched, set
		 *   <code>bubbles</code>
		 *   to true.
		 * </p>
		 */
		 ...
		 */
		public function TextField(arguments:Object) {
		}
		 ...
		 * </p>
		 */
		public static function create(arguments:Object):TextField {
			return null;
		}
